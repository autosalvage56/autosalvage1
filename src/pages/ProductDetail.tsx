            ...
            >
              ...
              <div className="mb-8 space-y-3">
                ...
                <a
                  ...
                  className="flex items-center justify-center w-full bg-red-600 hover:bg-red-700 text-white font-semibold rounded-md h-11 px-4 sm:px-8 text-sm sm:text-base transition-colors"
                >
                  <Phone className="w-5 h-5 mr-2 flex-shrink-0" />
                  <span className="whitespace-nowrap">Call Now: (888) 210-8563</span>
                </a>
              </div>
