      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center">
            <img loading="lazy" decoding="async" src={autoLogo} alt="AutoSalvage" className="h-12" />
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button className="relative h-10 w-10 border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground">
                    ...
                    <>
                        ...
                        <div key={item.id} className="flex gap-4 py-4 border-b">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              <Button
                                className="h-9 rounded-md px-3 border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground"
                              ...
                              <Button
                                className="h-9 rounded-md px-3 ml-auto bg-destructive text-destructive-foreground hover:bg-destructive/90"
                      ...
                      <div className="pt-4 space-y-2">
                        ...
                        <a
                          ...
                          className="flex items-center justify-center w-full bg-red-600 hover:bg-red-700 text-white font-semibold rounded-md h-10 px-4 text-sm transition-colors"
                        >
                          <Phone className="w-4 h-4 mr-2" />
                          Call Now: (888) 210-8563
                        </a>
